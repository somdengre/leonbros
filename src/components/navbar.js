  ...
  return (
    <nav className='ubox'>
        ...
        <div className='nav-row'>
          ...
          <div><a href="/" className='logo'> <img src={homeImage}/> </a></div>
          <div><a href="/product">PRODUCT</a></div>
          <div><a href="/news">NEWS</a></div>
          <div className='input-class'><input className = 'in' type='text' placeholder='Search by part number'/><div className='search-icon'> <img src={search}/> </div></div> 
